...
group1 = Group.new(
  ...
  group1.administrator = User.first
  group1.save
...
group2 = Group.new(
  ...
  group2.administrator = User.last
  group2.save
...
group3 = Group.new(
  ...
  group3.administrator = User.first
  group3.save
...
group4 = Group.new(
  ...
  group4.administrator = User.last
  group4.save
...
group5 = Group.new(
  ...
  group5.administrator = User.first
  group5.save
